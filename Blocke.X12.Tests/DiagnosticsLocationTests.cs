...
public sealed class DiagnosticsLocationTests
{
    ...
    private static void AssertUnknown(DiagnosticLocation loc)
    {
        Assert.Equal(-1, loc.SegmentIndex);
        Assert.Null(loc.ElementIndex);
        Assert.Equal(-1, loc.RawOffset);
    }
    ...
    public void MissingSegmentDiagnostic_uses_unknown_location()
    {
        ...
        var d = Assert.Single(diags.OfType<MissingSegmentDiagnostic>(), x => x.SegmentId == "SE");
        AssertUnknown(d.Location);
    }
    ...
    public void UnexpectedSegmentDiagnostic_has_segment_location()
    {
        ...
        var d = Assert.Single(diags.OfType<UnexpectedSegmentDiagnostic>(), x => x.SegmentId == "ZZZ");
    ...
    public void SegmentRepeatExceeded_uses_unknown_location()
    {
        ...
        var d = Assert.Single(diags.OfType<SegmentRepeatExceeded>(), x => x.SegmentId == "REF");
        AssertUnknown(d.Location);
    }
    ...
    public void LoopRepeatExceeded_uses_unknown_location()
    {
        ...
        var d = Assert.Single(diags.OfType<LoopRepeatExceeded>(), x => x.LoopId == "A");
        AssertUnknown(d.Location);
    }
    ...
    public void RuleViolationDiagnostic_has_segment_location()
    {
        ...
        var d = Assert.Single(diags.OfType<RuleViolationDiagnostic>(), x => x.RuleId == "hdr-rule");
        Assert.True(d.Location.SegmentIndex >= 0);
        Assert.True(d.Location.RawOffset >= 0);
        Assert.Null(d.Location.ElementIndex);
    }
    ...
    public void MissingElementDiagnostic_has_element_location()
    {
        ...
        var d = Assert.Single(diags.OfType<MissingElementDiagnostic>(), x => x.SegmentId == "HDR" && x.ElementIndex == 1);
        Assert.True(d.Location.SegmentIndex >= 0);
    ...
    public void InvalidElementTypeDiagnostic_has_element_location()
    {
        ...
        var d = Assert.Single(diags.OfType<InvalidElementTypeDiagnostic>(), x => x.SegmentId == "HDR" && x.ElementIndex == 1);
        Assert.True(d.Location.SegmentIndex >= 0);
        Assert.Equal(1, d.Location.ElementIndex);
        Assert.True(d.Location.RawOffset >= 0);
    }
    ...
    public void InvalidElementLengthDiagnostic_has_element_location()
    {
        ...
        var d = Assert.Single(diags.OfType<InvalidElementLengthDiagnostic>(), x => x.SegmentId == "HDR" && x.ElementIndex == 1);
        Assert.True(d.Location.SegmentIndex >= 0);
        Assert.Equal(1, d.Location.ElementIndex);
        Assert.True(d.Location.RawOffset >= 0);
    }
    ...
    public void InvalidElementCodeDiagnostic_has_element_location()
    {
        ...
        var d = Assert.Single(diags.OfType<InvalidElementCodeDiagnostic>(), x => x.SegmentId == "HDR" && x.ElementIndex == 1);
        Assert.True(d.Location.SegmentIndex >= 0);
        Assert.Equal(1, d.Location.ElementIndex);
        Assert.True(d.Location.RawOffset >= 0);
    }
    ...
    public void TransactionSyntaxDiagnostic_has_segment_location()
    {
        ...
        var d = Assert.Single(diags.OfType<TransactionSyntaxDiagnostic>(), x => x.Error == "SegmentCountMismatch");
        Assert.True(d.Location.SegmentIndex >= 0);
        Assert.True(d.Location.RawOffset >= 0);
        Assert.Null(d.Location.ElementIndex);
    }
    ...
    public void EmptySegmentSpecDiagnostic_uses_unknown_location()
    {
        ...
        var d = Assert.Single(diags.OfType<EmptySegmentSpecDiagnostic>(), x => x.SegmentId == "N9");
        AssertUnknown(d.Location);
    }
    ...
    public void IdElementMissingCodeListDiagnostic_uses_unknown_location()
    {
        ...
        var d = Assert.Single(diags.OfType<IdElementMissingCodeListDiagnostic>(), x => x.SegmentId == "N9" && x.ElementId == "N901");
        AssertUnknown(d.Location);
    }
}
